...
public class UfhUtil{
	...
	public static class UhfGetData{
		...
		public static int Read6C(byte ENum,byte EPC[],byte Mem,byte WordPtr,byte Num,byte Password[]){
		...
		public static int Write6c(byte WNum,byte ENum,byte EPC[],byte Mem,byte WordPtr,byte Writedata[],byte Password[]){
		...
		public static int Write6B(byte ID_6B1[],byte StartAddress,byte Writedata[],byte Writedatalen){
